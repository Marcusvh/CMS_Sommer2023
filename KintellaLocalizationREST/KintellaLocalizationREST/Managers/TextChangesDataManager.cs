...
namespace KintellaLocalizationREST.Managers
{
    public class TextChangesDataManager
    {
        ...
        public bool DeleteTextChanges(int textChangesID)
        {
            ...
            try
            {
                Text textToDelete = _context.Texts.Find(textChangesID);
                TextChanges textChanges = new();
                textChanges.TextObject = textToDelete;
                textChanges.TextChangeTo = textToDelete.TextContent;
                textChanges.TextChangeFrom = "DELETE";
                textChanges.DateModified = DateTime.Now.ToUniversalTime();
                _context.TextChanges.Add(textChanges);
                _context.SaveChanges();
            }
            catch (Exception e)
        ...
        public bool PublishText(int textChangeID)
        {
            try
            {
                ...
                if(newTextChange.TextChangeFrom == "DELETE")
                {
                    _context.Texts.Remove(newTextChange.TextObject);
